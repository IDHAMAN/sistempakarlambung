...
<div class="kiri">
    ...
    <form action="function.php?act=tambahGejalaDokter" id="tambah" method="POST" >
        <div class="form-group">
            <label for="namaGejala">Gejala</label>
            <input type="text" class="form-control" id="id_Gejala" name="namaGejala"  placeholder="Masukkan gejala">
        </div>
