            ...
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="function.php?act=hapusRelasi&id_relasi=<?= $data['id_relasi']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
