  ...
  <body> 
    <nav class="navbar py-2 navbar-expand-lg navbar-light">
      <div class="container">
        <a class="navbar-brand" href="#"
          ><img src="gambar/logo sistem.png" width="120" alt="logo" 
        /></a> <h2>Sistem Pakar</h2>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item align-self-center active">
              <a class="nav-link"  href="#alur">Cara Kerja Sistem<span class="sr-only">(current)</span></a>
            </li>
                        ...
                        <div class="form-group">
                          <div id="result"></div>
                            <label for="nama" class="col-form-label">Username</label>
                              <input type="text" class="form-control" id="username" name="username" rows="3" placeholder="Username">
      ...
      <div class="container">
        <div class="row">
          <div class="col align-self-center">
            <h1 class="mb-4">Cek Lambung kamu Yuk !</h1>
            <p class="mb-4">
              Cek Lambung Kamu Yuk ! merupakan suatu sistem pakar yang di buat untuk mendiagnosa penyakit lambung. Sistem ini berkerja dengan menanyakan gejala awal yang di rasakan oleh penderita penyakit lambung dan menyimpulkan suatu penyakit bedasarkan gejala yang di alami oleh penderita, dan juga ada tampilan Arikel terkait penyakit lambung untuk mengetahui jenis-jenis penyakit lambung berserta penanganan nya.
            </p>
            <a class="btn btn-primary" href="halaman.php" role="button">ARTIKEL PENYAKIT LAMBUNG</a>
          </div>
          <div class="col d-none d-sm-block">
            <img width="450" src="gambar/teknologi.jpg"  alt="" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="alur">
      <div id="konten2" class="container konten">
        <h2 style="font-weight: bold;text-align: center;">Alur Kerja Sistem Pakar !</h2>
        <div class="card-deck">
          <div class="card">
