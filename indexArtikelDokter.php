        ...
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr class="d-flex">
                        <td class="col-2">
                        <a class="badge badge-pill badge-primary" href="ubahArtikelDokter.php?id_artikel=<?php echo $data["id_artikel"]; ?>">edit</a> |
                        <a href="function.php?act=hapusArtikelDokter&id_artikel=<?= $data['id_artikel']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
                ...
                <a href="tambahArtikelDokter.php" class="btn btn-primary my-2 px-2">Tambah Data Artikel</a>
                </table>
            </form>
        </div>
    </div>
