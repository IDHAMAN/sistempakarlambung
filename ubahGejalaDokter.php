...
<div class="kiri">
    ...
    <div class="kanan">
        ...
        <!-- Content Row -->
            <div class="row">
            <form action="function.php?act=ubahGejalaDokter&id_gejala=<?= $gejala['id_gejala']; ?>" id="ubah" method="POST">
                    <div class="form-group">
                        <label for="namaGejala">Nama Gejala</label>
                        <input type="text" class="form-control" id="namaGejala" name="namaGejala" value="<?= $gejala['gejala']; ?>"">
                    </div>
