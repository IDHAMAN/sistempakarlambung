...
<div class="container">
    <div class="card text-center">
        <div class="card-title">
            <h1 class="card-title">Halaman Registrasi Dokter</h1>
        </div>
        <div class="card-body ">
            ...
            <div class="form-row">
                    ...
                    <div class="col">
                        <label class="papan" for="nama">Nama Dokter</label>
                ...
                <div class="container signin">
                    <p>Kembali ke halaman Dashboar<a href="indexAdmin.php">Kembali</a></p>
                <!-- Modal -->
                </div>
            </form>
        </div>
