        ...
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                        <a class="badge badge-pill badge-primary" href="ubahGejalaDokter.php?id_gejala=<?php echo $data["id_gejala"]; ?>">edit</a> |
                        <a href="function.php?act=hapusGejalaDokter&id_gejala=<?= $data['id_gejala']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
                ...
                <a href="tambahGejalaDokter.php" class="btn btn-primary my-2 px-2">Tambah Data Gejala</a>
                </table>
            </form>
        </div>
    </div>
