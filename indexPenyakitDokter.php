            ...
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="function.php?act=hapusPenyakitDokter&id_penyakit=<?= $data['id_penyakit']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
                ...
                <a href="tambahPenyakitDokter.php" class="btn btn-primary my-2 px-2">Tambah Data Penyakit</a>
                </table>
            </form>
        </div>
    </div>
