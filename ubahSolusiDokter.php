    ...
    <div class="kanan">
        ...
        <!-- Content Row -->
            <div class="row">
                ...
                <form action="function.php?act=ubahSolusiDokter&id_solusi=<?= $data['id_solusi']; ?>" id="ubah" method="POST">
                <div class="form-group">
                    <label for="namaSolusi">Solusi</label>
                    <input type="text" class="form-control" id="namaSolusi" name="namaSolusi" value="<?= $data['solusi_penyakit']; ?>"">
                </div>
                <div class="form-group">
