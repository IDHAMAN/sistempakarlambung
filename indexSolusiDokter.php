...
$querySolusi = mysqli_query($koneksi, "SELECT solusi.id_solusi, penyakit.penyakit, solusi.solusi_penyakit 
                                       FROM solusi INNER JOIN penyakit 
                                       ON solusi.id_penyakit = penyakit.id_penyakit");
        ...
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr class="d-flex">
                        <td class="col-2">
                        <a class="badge badge-pill badge-primary" href="ubahSolusiDokter.php?id_solusi=<?php echo $data["id_solusi"]; ?>">edit</a> |
                        <a href="function.php?act=hapusSolusiDokter&id_solusi=<?= $data['id_solusi']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
                        <td class="col-1"><?= $data['id_solusi']; ?></td>
                        <td class="col-3"><?= $data['penyakit']; ?></td>
                        <td class="col-6"><?= $data['solusi_penyakit']; ?></td>
                        
                    </tr>
                    <?php } ?>
                </tbody>
                <a href="tambahSolusiDokter.php" class="btn btn-primary my-2 px-2">Tambah Data Solusi</a>
                </table>
            </form>
        </div>
    </div>
